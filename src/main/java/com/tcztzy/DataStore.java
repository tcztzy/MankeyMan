...
public final class DataStore extends DataStoreBase {
    ...
    private static final ap[] J = new ap[]{new ap(0, 0, 0, 0, new Point(120, 60), 0, true), new ap(1, 1, 8, 0, new Point(120, 188), 0, true)};
    private final l[] K = new l[]{new l(0, 111), new l(1, 97), new l(2, 21)};
    private static ap[] L = new ap[]{new ap(0, 0, 0, 0, new Point(122, 72), 28667, true), new ap(1, 1, 0, 0, new Point(120, 160), new z(0, 0, 240, 320), 28670, true), new ap(3, 2, 1, 0, new Point(0, 0), new z(0, 0, 105, 72), 28669, true), new ap(4, 2, 3, 2, new Point(240, 0), new z(0, 0, 105, 72), 28669, true), new ap(5, -1, 8, 0, new Point(0, 0), new z(0, 0, 42, 20), 28663, true), new ap(6, -1, 8, 0, new Point(0, 0), new z(0, 20, 42, 20), 28663, true), new ap(7, -1, 8, 0, new Point(0, 0), new z(0, 40, 42, 20), 28663, true), new ap(8, -1, 8, 0, new Point(0, 0), new z(0, 60, 42, 20), 28663, true), new ap(9, -1, 0, 0, new Point(54, 200), 28665, true), new ap(10, -1, 0, 0, new Point(99, 200), 28665, true), new ap(11, -1, 0, 0, new Point(145, 200), 28665, true), new ap(12, -1, 0, 0, new Point(189, 200), 28665, true), new ap(13, -1, 0, 0, new Point(0, 0), new z(13, 0, 12, 15), 28663, false), new ap(14, -1, 0, 0, new Point(0, 0), new z(25, 0, 12, 15), 28663, false)};
    ...
    public final void c() {
        ...
        switch(this.getD()) {
            case 0:
                ...
                g = null;
                MankeyManCanvas.loading(H, d, MESSAGES, this.di, true);
                aiClass.y = (p) MankeyManCanvas.a(new p(), this);
                aiClass.A = (al) MankeyManCanvas.a(new al());
                this.h(7);
                return;
            case 1:
            case 2:
            ...
            case 7:
                    ...
                    switch(p) {
                        ...
                        case 5:
                            if(o == 0) {
                                ...
                                MankeyManCanvas.b(h);
                                h = null;
                                MankeyManCanvas.a(this.K, null, null, null);
                                s[5].g(1);
                                s[5].f(0, 0);
                                s[5].setFlag2(true);
                            } else if(MankeyManCanvas.d(4194304)) {
                        ...
                        case 6:
                            if(!c) {
                                MankeyManCanvas.getImage(215, 204);
                                this.u = new d[5];
                        ...
                        case 7:
                            if(!this.w) {
                                MankeyManCanvas.getImage(133, 133);
                                this.v = new d[1];
                ...
                k = null;
                j = null;
                MankeyManCanvas.loading(this.K, null, null, null, false);
                MankeyManCanvas.getImage(230, 130);
                MankeyManCanvas.getImage(231, 200);
                MankeyManCanvas.getImage(232, 201);
                MankeyManCanvas.getImage(233, 202);
                MankeyManCanvas.getImage(234, 203);
                MankeyManCanvas.getImage(240, 300);
                MankeyManCanvas.getImage(241, 301);
            ...
            case 9:
                if(!q) {
                    j = null;
                    MankeyManCanvas.loading(I, null, null, null, false);
                ...
                switch(p) {
                    ...
                    case 1:
                        ...
                        j = (u) MankeyManCanvas.a(new u(var4, aiClass.t), this);
                        break;
                    case 2:
                        if(o == 2) {
                            q = false;
                ...
                if(!q) {
                    MankeyManCanvas.b(h);
                    h = null;
                    MankeyManCanvas.a(I, null, null, null);
                    MankeyManCanvas.c(8);
                    this.h(7);
                }
        }
    ...
    public static int a(char var0) {
        String var1 = MankeyManCanvas.getMessage(216); // "下不中丹丽了人他伊休伤伽位候儿其冰凡凯判前劣化卡危即卷受古啦啸器图垛夏多天奈始娜婖婴孔孕季宏尚已巴布幼开式强徙徳怀恐息恶惠戏打文族旧昌晴暑期机束来果枫桑欧正气水河波泰洪海游火灭灾烂物狩猎玛琳瑞瑟生疫病皮石禆空米纱结绝罗美老腐腹芋芬莉菁萨落蒙虞裘言詹谈足迁进造部采金长阳集雨雪雷露风食龙祈祷　　　　　　　　　　　　　　　　"
    ...
    static String getNumberString(int var0, int digitWidth, boolean var2) {
        ...
        for(int i = 0; i < digitWidth; ++i) {
            int digit;
            if((digit = var0 / DataStore.digit[digitWidth - i - 1] % 10) <= 0 && !var3 && (digit != 0 || i != digitWidth - 1)) {
                digit = 11;
            } else {
                var3 = true;
            }
